...
const CSS_CLASSES = {
  ...
  gridView: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3 animate-fadeIn",
  scrollView: "flex gap-2 overflow-x-auto no-scrollbar pb-2 touch-manipulation scroll-smooth px-1 sm:gap-3 sm:px-0",
  ...
  categoryButtonPill: "flex-shrink-0 flex items-center justify-center px-3 py-1.5 text-xs rounded-full whitespace-nowrap font-medium min-w-[60px] sm:px-4 sm:py-2 sm:text-sm sm:min-w-[80px] md:px-5 md:py-2.5 md:text-base md:min-w-[100px]",
