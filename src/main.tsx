...
function initApp() {
  ...
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
      // Register main service worker (generated by Vite PWA)
      navigator.serviceWorker.register('/sw.js', {
        ...
        .catch(error => {
          ...
          // Fallback: still initialize PWA features even if SW fails
          setTimeout(() => initPWA(), 1000);
        });
      ...
      navigator.serviceWorker.register('/firebase-messaging-sw.js', {
        ...
        .catch(error => {
          ...
          // This is non-critical, so we just warn
        });
    });
  } else {
    // No service worker support, still initialize PWA features
    setTimeout(() => initPWA(), 1000);
  }
}
